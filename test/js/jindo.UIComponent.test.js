...
var oUIComponent = new jindo.Test();

module("jindo.UIComponent", {
});
test("jindo.UIComponent는 isActivating, activate, deactivate 메소드를 가진다.", function(){
...
test("jindo.UIComponent를 상속받은 클래스의 인스턴스는 _onActivate, _onDeactivate 메소드를 가져야한다.", function(){
