...
test("get", function() {
	...
	var oKF = new jindo.Keyframe({ fEffect : jindo.Effect.linear });
	...
	oKF.set(0.5, [
		oObj1, { '@left' : jindo.Effect.easeIn('600px') }
	]);
...
test("frame", function() {
	...
	oKF.set(0.5, [
		oObj1, { '@left' : '600px' },
		oObj2, { '@left' : jindo.Effect.stepStart('50px'), '@textIndent' : jindo.Effect.stepEnd('-300px') },
