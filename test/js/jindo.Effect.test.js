...
var makeGraph = function(sEffect) {
	var f = jindo.Effect[sEffect](0, 200);
	if (sEffect == "pulse") {
		f = jindo.Effect[sEffect](3)(0, 200);	
	}
	if (sEffect == "wave") {
		f = jindo.Effect[sEffect](2, 0.5)(0, 200);
	}
...
test("인스턴스 생성시 에러", function() {
	var nOccured = 0;
	try { new jindo.Effect() } catch(e) { nOccured++; }
	try { jindo.Effect.linear('block', 'block') } catch(e) { nOccured++; }
	equal(nOccured, 2);
});
...
test('단위넣고 테스트', function() {
	var f = jindo.Effect.linear('100px', '200px');
	equal(f(0), '100px');
	equal(f(0.5), '150px');
	equal(f(1.0), '200px');
});
...
test('단위가 다르면 에러 발생', function() {
	...
	try { jindo.Effect.linear(100, '200px')(.1); } catch(e) { nOccured++; }
	try { jindo.Effect.linear('100', '200px')(.1); } catch(e) { nOccured++; }
	try { jindo.Effect.linear('100%', '200px')(.1); } catch(e) { nOccured++; }
	try { jindo.Effect.linear('100px', '200pt')(.1); } catch(e) { nOccured++; }
	try { jindo.Effect.linear('#ff00ff', 200)(.1); } catch(e) { nOccured++; }
	try { jindo.Effect.linear('rgb(255, 127, 0)', '200px')(.1); } catch(e) { nOccured++; }
	equal(nOccured, 6);
});

test('색상 단위 테스트', function() {
	var f = jindo.Effect.linear('#f0f', 'rgb(0, 255, 0)');
	equal(f(0), '#FF00FF');
	equal(f(0.5), '#808080');
	equal(f(1.0), '#00FF00');
	
	var f = jindo.Effect.linear('#000000', 'rgb(2, 2, 2)');
	equal(f(0), '#000000');
	equal(f(0.5), '#010101');
	equal(f(1.0), '#020202');

	var f = jindo.Effect.linear('#000000', 'rgba(2, 2, 2, 0)');
	equal(f(0), '#000000');
	...
	var f = jindo.Effect.linear('hsl(120, 50%, 20%)', 'hsl(700,20%,80%)');
	equal(f(0), 'hsl(120,50%,20%)');
	equal(f(0.5), 'hsl(410,35%,50%)');
	equal(f(1.0), 'hsl(700,20%,80%)');

	var f = jindo.Effect.linear('hsla(120, 50%, 20%, .4)', 'hsla(900,20%,80%,1)');
	equal(f(0), 'hsla(120,50%,20%,0.4)');
	equal(f(0.5), 'hsla(510,35%,50%,0.7)');
	equal(f(1.0), 'hsl(900,20%,80%)');

	var f = jindo.Effect.linear('rgb(0, 255, 0)', 'hsl(700,20%,80%)');
	equal(f(0), '#00FF00');
	equal(f(0.5), '#6BE165');
	equal(f(1.0), '#D6C2C9');

	var f = jindo.Effect.linear('rgba(0, 255, 0, 0)', 'hsla(700,20%,80%,1)');
...
test("linear(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.linear(0, 100);
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("sinusoidal(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.sinusoidal(0, 100);
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("overphase(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.overphase(0, 100);
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("mirror(0, 100) 이펙트의 초기값은 0, 중간값은 100, 마지막 값은 0이다.", function() {
	var f = jindo.Effect.mirror(0, 100);
	equal(f(0), 0);
	equal(f(0.5), 100);
	equal(f(1), 0);
});
...
test("pulse(3)(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.pulse(2)(0, 100);
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("wave(2, 0.5)(0, 100) 이펙트의 초기값은 0, 마지막 값은 0이다.", function() {
	var f = jindo.Effect.wave(2, 0.5)(0, 100);
	equal(f(0), 0);
	equal(f(1), 0);
});
...
test("bounce(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.bounce(0, 100)
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("cubicEase(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.cubicEase(0, 100)
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("cubicEaseIn(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.cubicEaseIn(0, 100)
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("cubicEaseOut(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.cubicEaseOut(0, 100)
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("cubicEaseInOut(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.cubicEaseInOut(0, 100)
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("cubicEaseOutIn(0, 100) 이펙트의 초기값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.cubicEaseOutIn(0, 100)
	equal(f(0), 0);
	equal(f(1), 100);
});
...
test("stepStart(0, 100) 이펙트의 초기값은 0, 중간값은 100, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.stepStart(0, 100)
	equal(f(0), 0);
	equal(f(0.5), 100);
	equal(f(1), 100);
});
...
test("stepEnd(0, 100) 이펙트의 초기값은 0, 중간값은 0, 마지막 값은 100이다.", function() {
	var f = jindo.Effect.stepEnd(0, 100)
	equal(f(0), 0);
	equal(f(0.5), 0);
	equal(f(1), 100);
});
...
test("linear(0, 100px) 의 0.5 시점은 50px", function() {
	var f = jindo.Effect.linear(0, '100px')
	equal(f(0.5), '50px');
});
...
test("linear('-500px 100px 3em 20%', '300px 0% 5em 80%') 의 0.5 시점은 '-100px 50px 4em 50%'", function() {
	var f = jindo.Effect.linear('-500px 100px 3em 20%', '300px 0% 5em 80%')
...
test("linear('50px', '0px 20px 30px 40px') 의 0.5 시점은 '25px 35px 40px 45px'", function() {
	var f = jindo.Effect.linear('50px', '0px 20px 30px 40px')
...
test("linear('50px 100px', '0px 20px 30px 40px') 의 0.5 시점은 '25px 60px 40px 70px'", function() {
	var f = jindo.Effect.linear('50px 100px', '0px 20px 30px 40px')
...
test("linear('50px 100px 0px', '0px 20px 30px 40px') 의 0.5 시점은 '25px 60px 15px 70px'", function() {
	var f = jindo.Effect.linear('50px 100px 0px', '0px 20px 30px 40px')
...
test("linear('0% 0% 0% 0%', '100px 120px 60em 50%') 의 0.5 시점은 '50px 60px 30em 25%'", function() {
	var f = jindo.Effect.linear('0% 0% 0% 0%', '100px 120px 60em 50%')
